    ...
    <section className="relative overflow-hidden bg-ink py-24 sm:py-32">
      ...
      <div className="container-c relative">
        <RevealSection className="max-w-2xl">
          ...
          <h2 className="mt-4 font-display text-section font-bold text-white">See exactly what walks out your door every year</h2>
        ...
        <RevealSection className="mt-12 grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-4">
            <div className="rounded-2xl border border-white/10 bg-space-800/50 p-6">
              <div className="font-display text-4xl font-extrabold text-white">{walkPerYear.toLocaleString()}</div>
              <p className="mt-1 text-sm text-slate-400">patients walk out every year without scheduling, and most never get a single real follow-up.</p>
            </div>
            <div className="rounded-2xl border border-rose-500/25 bg-rose-500/5 p-6">
              <div className="font-display text-4xl font-extrabold text-rose-300">{fmt$(lostProduction)}</div>
